...
module.exports = {
  ...
  tracking: async function (req, res) {
    try {
      ...
      logger.error(error);
      response.APIError(req, res, constants.error.rest.tracking + ' ' + constants.error.controlador);
    }
  },
  ...
  collection: async function (req, res) {
    try {
      ...
      logger.error(error);
      response.APIError(req, res, constants.error.rest.collection + ' ' + constants.error.controlador);
    }
  },
  ...
  createbyadmin: async function (req, res) {
    try {
      ...
      logger.error(error);
      response.APIError(req, res, constants.error.rest.createbyadmin + ' ' + constants.error.controlador);
    }
  },
  ...
  updatebyadmin: async function (req, res) {
    try {
      ...
      logger.error(error);
      response.APIError(req, res, constants.error.rest.updatebyadmin + ' ' + constants.error.controlador);
    }
  },
  ...
  deletebyadmin: async function (req, res) {
    try {
      ...
      if (!parseResult.success) {
        logger.error(parseResult);
        response.APIError(req, res, validacion);
        return;
      ...
      logger.error(error);
      response.APIError(req, res, constants.error.rest.deletebyadmin + ' ' + constants.error.controlador);
    }
  }
